...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="bg-white p-6 rounded shadow-md w-96">
        <h2 class="text-2xl font-bold mb-4 text-center">Create Organization</h2>
        ...
        <form action="{{ route('organizations.store') }}" method="POST">
            ...
            <button type="submit" class="bg-blue-500 text-white w-full p-2 rounded">Create Organization</button>
        </form>
    </div>
</body>
</html>
